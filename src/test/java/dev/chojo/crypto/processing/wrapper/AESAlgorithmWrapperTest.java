...
class AESAlgorithmWrapperTest {
    ...
    @Test
    void testDestroy() throws InvalidKeySpecException, InvalidAlgorithmParameterException,
            NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, javax.security.auth.DestroyFailedException {
    ...
    @Test
    void testDecryptionWithoutIV() throws InvalidKeySpecException, NoSuchPaddingException,
            NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException {
        AESAlgorithmWrapper decryptWrapper = new AESAlgorithmWrapper(cryptoService.randomAESKey().key(),
                cryptoService.aesCipher(), Cipher.DECRYPT_MODE);
    ...
    @Test
    void testProcessedBytes() throws InvalidKeySpecException, NoSuchPaddingException,
            NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException,
            IllegalBlockSizeException, BadPaddingException {
        AESAlgorithmWrapper encryptWrapper = new AESAlgorithmWrapper(cryptoService.randomAESKey().key(),
                cryptoService.aesCipher(), Cipher.ENCRYPT_MODE);
    ...
    @Test
    void testEqualsAndHashCode() throws InvalidKeySpecException, InvalidAlgorithmParameterException,
            NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
        AESAlgorithmWrapper wrapper1 = cryptoService.randomAESKey();
        AESAlgorithmWrapper wrapper2 = new AESAlgorithmWrapper(wrapper1.key(), wrapper1.cipherName(), wrapper1.opMode());
        AESAlgorithmWrapper wrapper3 = cryptoService.randomAESKey();
        AESAlgorithmWrapper wrapper4 = new AESAlgorithmWrapper(wrapper1.key(), "AES/CBC/PKCS5Padding", wrapper1.opMode());
    ...
    @Test
    void testGetters() throws InvalidKeySpecException, InvalidAlgorithmParameterException,
            NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
        AESAlgorithmWrapper wrapper = cryptoService.randomAESKey();
    ...
    void testLazyCipherLockInit() throws Exception {
        ...
        // Calling it again should use the same cipher object (internal state might change but it's the same ConcurrentCipher)
        AESProcessResult result2 = wrapper.process(new AESProcessInput(message.getBytes(), null));
        assertNotNull(result2);
    }

    @Test
    void testNonDeterministicEncryption() throws InvalidKeySpecException, NoSuchPaddingException,
            NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException,
            IllegalBlockSizeException, BadPaddingException {
        AESAlgorithmWrapper encryptWrapper = new AESAlgorithmWrapper(cryptoService.randomAESKey().key(),
                cryptoService.aesCipher(), Cipher.ENCRYPT_MODE);
        ...
        assertNotEquals(Arrays.toString(result1.bytes()), Arrays.toString(result2.bytes()), "Encryption should be non-deterministic (different IVs)");
        assertNotNull(result1.iv());
        assertNotNull(result2.iv());

        AESAlgorithmWrapper decryptWrapper = new AESAlgorithmWrapper(encryptWrapper.key(),
                cryptoService.aesCipher(), Cipher.DECRYPT_MODE);
        Decryptor<AESProcessInput, AESProcessResult> decryptor = new Decryptor<>(decryptWrapper);
