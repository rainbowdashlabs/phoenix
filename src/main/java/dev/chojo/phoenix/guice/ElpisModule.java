 ...
 */
package dev.chojo.phoenix.guice;
...
import dev.chojo.phoenix.DiscordOAuthService;
import dev.chojo.phoenix.MailService;
...
public class PhoenixModule extends AbstractModule {
    ...
    public PhoenixModule(Configuration configuration) {
